        ...
        >
          <Box>
            <Heading
              ...
              size={{ xl: "lg", sm: "lg" }}
            >
              <b>PROYECTO FINAL CaC REACT GRUPO 5</b>, UN ECOMMERCE PARA
              APRENDER Y APLICAR <b>TECNOLOGIAS WEB.</b>
            </Heading>
            <Button
              className="animate__animated animate__fadeInLeft"
              as="a"
      ...
      <Container maxW="2x1" bgColor="#E8E8E8">
        <Flex justifyContent="center">
          <Box textAlign="center" maxW="1000" py="10">
            <Heading className="animate__animated animate__fadeInDown" pb="2">
              ¡TENEMOS UN TICKET DE REGALO PARA VOS!
            </Heading>
